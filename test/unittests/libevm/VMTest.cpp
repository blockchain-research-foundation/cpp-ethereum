...
public:
    ...
    void testExtcodehashHasCorrectCost()
    {
        ...
        bigint gasBefore;
        bigint gasAfter;
        auto onOp = [&gasBefore, &gasAfter](uint64_t /*steps*/, uint64_t /* PC */, Instruction _instr, bigint /*newMemSize*/, bigint /*gasCost*/, bigint _gas, VMFace const*, ExtVMFace const*)
        {
    ...
    void testExtcodehashIgnoresHigh12Bytes()
    {
        ...
        bytes extAddressPrefixed = bytes{1, 2, 3, 4, 5, 6, 7, 8, 9, 0xa, 0xb, 0xc} + extAddress.ref();
